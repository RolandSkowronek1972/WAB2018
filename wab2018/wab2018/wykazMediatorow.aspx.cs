...
namespace wab2018
{
    public partial class wykazMediatorow : System.Web.UI.Page
    {
        ...
        {
            ASPxDateZakreslenie.Enabled = CheckBox4.Checked;
        }
        ...
        protected void ASPxGridView7_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
        {
        ...
        protected void ustaw_baze()
        {
            ...
            if (CheckBox4.Checked)
            {
                ...
                if (CheckBox1.Checked)
                {
                    ...
                    kwerenda = "SELECT DISTINCT View_ListaMediatorow.tytul as tytul, View_ListaMediatorow.imie as imie,  View_ListaMediatorow.uwagi as uwagi, View_ListaMediatorow.nazwisko as nazwisko, View_ListaMediatorow.adres as adres,View_ListaMediatorow.tel1 as telefon, View_ListaMediatorow.specjalizacja_opis as opis , View_ListaMediatorow.data_poczatkowa as data_poczatkowa, View_ListaMediatorow.data_koncowa as data_koncowa,View_ListaMediatorow.ident as ident, View_ListaMediatorow.adres2 as adres2, View_ListaMediatorow.zawieszony as zawieszony, View_ListaMediatorow.specjalizacjeWidok as specjalizacjeWidok FROM  View_ListaMediatorow LEFT OUTER JOIN tbl_specjalizacje_osob ON View_ListaMediatorow.ident = tbl_specjalizacje_osob.id_osoby WHERE (tbl_specjalizacje_osob.id_specjalizacji = " + DropDownList1.SelectedValue.ToString().Trim() + ") and View_ListaMediatorow.data_koncowa<=getdate() order by nazwisko";
                ...
                else
                {
                    ...
                    kwerenda = "SELECT DISTINCT View_ListaMediatorow.tytul as tytul, View_ListaMediatorow.imie as imie,  View_ListaMediatorow.uwagi as uwagi, View_ListaMediatorow.nazwisko as nazwisko, View_ListaMediatorow.adres as adres,View_ListaMediatorow.tel1 as telefon, View_ListaMediatorow.specjalizacja_opis as opis , View_ListaMediatorow.data_poczatkowa as data_poczatkowa, View_ListaMediatorow.data_koncowa as data_koncowa,View_ListaMediatorow.ident as ident, View_ListaMediatorow.adres2 as adres2, View_ListaMediatorow.zawieszony as zawieszony, View_ListaMediatorow.specjalizacjeWidok as specjalizacjeWidok FROM  View_ListaMediatorow LEFT OUTER JOIN tbl_specjalizacje_osob ON View_ListaMediatorow.ident = tbl_specjalizacje_osob.id_osoby where  View_ListaMediatorow.data_koncowa <= getdate() order by nazwisko";
                      ...
                      case 1:
                          {
                              ...
                              string idSspecjalizacji = DropDownList1.SelectedValue.ToString().Trim();
                                        //SELECT DISTINCT tytul, imie, nazwisko, adres, data_poczatkowa, data_koncowa, ident, adres2, zawieszony, (specjalizacjeWidok +' '+ specjalizacja_opis) as specjalizacjeWidok ,  uwagi, specjalizacja_opis, tel1 as telefon FROM View_ListaMediatorow where data_koncowa>=getdate() order by nazwisko
                              kwerenda = "SELECT DISTINCT View_ListaMediatorow.tytul as tytul, View_ListaMediatorow.imie as imie,  View_ListaMediatorow.uwagi as uwagi, View_ListaMediatorow.nazwisko as nazwisko, View_ListaMediatorow.adres as adres,View_ListaMediatorow.tel1 as telefon, View_ListaMediatorow.specjalizacja_opis as opis , View_ListaMediatorow.data_poczatkowa as data_poczatkowa, View_ListaMediatorow.data_koncowa as data_koncowa,View_ListaMediatorow.ident as ident, View_ListaMediatorow.adres2 as adres2, View_ListaMediatorow.zawieszony as zawieszony, View_ListaMediatorow.specjalizacjeWidok as specjalizacjeWidok FROM  View_ListaMediatorow LEFT OUTER JOIN tbl_specjalizacje_osob ON View_ListaMediatorow.ident = tbl_specjalizacje_osob.id_osoby WHERE (tbl_specjalizacje_osob.id_specjalizacji = " + DropDownList1.SelectedValue.ToString().Trim() + ") and  View_ListaMediatorow.data_koncowa>=getdate() order by nazwisko";
    ...
    //        BaseFont plFont2NEW = BaseFont.CreateFont(Server.MapPath("/fonts/") + "ARIAL.TTF", BaseFont.CP1257, BaseFont.EMBEDDED);
            Font plFont1 = FontFactory.GetFont(BaseFont.HELVETICA, BaseFont.CP1257, 10, Font.NORMAL);

            Font plFont =  FontFactory.GetFont(BaseFont.HELVETICA, BaseFont.CP1257, 10, Font.NORMAL);

            Font plFont2 = FontFactory.GetFont(BaseFont.HELVETICA, BaseFont.CP1257, 10, Font.NORMAL);
            Font plFontBIG = FontFactory.GetFont(BaseFont.HELVETICA, BaseFont.CP1257, 15, Font.BOLD);
        ...
        //    var plFontBIG = FontFactory.GetFont(BaseFont.HELVETICA, BaseFont.CP1257, 35, Font.NORMAL);
            ...
            Font plFont3 = FontFactory.GetFont(BaseFont.HELVETICA, BaseFont.CP1257, 15, Font.NORMAL);
            ...
            if (Biegli.Rows.Count > 0)
            {
                ...
                tabelaGlowna.AddCell(new Paragraph("Adres- telefon", plFont2));
        ...
        protected void robRaportWszystkichSpecjalizacji()
        {
            ...
            Font fontPL1 = FontFactory.GetFont(BaseFont.HELVETICA, BaseFont.CP1257, 10, Font.NORMAL);
            Font plFont2 = FontFactory.GetFont(BaseFont.HELVETICA, BaseFont.CP1257, 9, Font.NORMAL);
            Font plFont3 = FontFactory.GetFont(BaseFont.HELVETICA, BaseFont.CP1257, 15, Font.NORMAL);
            Font plFontBIG = FontFactory.GetFont(BaseFont.HELVETICA, BaseFont.CP1257, 10, Font.NORMAL);
        ...
        protected PdfPTable generujCzescRaportu(DataTable biegli, string specjalizacje)
        {
         ...
         //   BaseFont plFont2NEW = BaseFont.CreateFont(Server.MapPath("/fonts/") + "ARIAL.TTF", BaseFont.CP1257, BaseFont.EMBEDDED);
            ...
            foreach (DataRow biegly in biegli.Rows)
            {
                ...
                tabelaGlowna.AddCell(new Paragraph(iterator.ToString(), plFont1));
                tabelaGlowna.AddCell(new Paragraph(innerTable, plFont1));
                ...
                tabelaGlowna.AddCell(new Paragraph(adresTable, plFont1));
