        ...
        <table style="width: 100%;">
            <tr>
               ...
               <asp:LinkButton ID="LinkButton14" runat="server" CssClass="button_" OnClick="tworzZestawienie" meta:resourcekey="LinkButton14Resource1" Text="Zestawienie"></asp:LinkButton>
                    ...
                    <asp:LinkButton ID="LinkButton15" runat="server" CssClass="button_" meta:resourcekey="LinkButton14Resource1" Text="Zestawienie BIP" Width="124px" OnClick="tworzZestawienieBIPexcelNew"></asp:LinkButton>
                </td>
