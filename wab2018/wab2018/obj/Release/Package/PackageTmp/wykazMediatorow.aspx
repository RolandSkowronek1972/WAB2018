<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="wykazMediatorow.aspx.cs" Inherits="wab2018.wykazMediatorow" EnableEventValidation="true"  %>
...
<script src="https://code.jquery.com/jquery-1.12.4.min.js"></script>
     ...
     <div id ="mainWindow" class="newPage">  <h2>         Wykaz Mediatorów sądowych</h2>
...
<asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" 
           ...
           <td align="right" style="width: 400px" >
               ...
               <asp:LinkButton ID="LinkButton14" runat="server" CssClass="button_" OnClick="twórzZestawienie" meta:resourcekey="LinkButton14Resource1" Text="zestawienie" Visible="False"></asp:LinkButton>
         ...
         <asp:Panel ID="normalny" runat="server">
             ...
             <br />
             <asp:SqlDataSource ID="daneBieglych" runat="server" ConnectionString="<%$ ConnectionStrings:wap %>" SelectCommand="SELECT DISTINCT View_ListaMediatorow.tytul as tytul, View_ListaMediatorow.imie as imie,  View_ListaMediatorow.uwagi as uwagi, View_ListaMediatorow.nazwisko as nazwisko, View_ListaMediatorow.adres as adres,View_ListaMediatorow.tel1 as telefon, View_ListaMediatorow.specjalizacja_opis as opis , View_ListaMediatorow.data_poczatkowa as data_poczatkowa, View_ListaMediatorow.data_koncowa as data_koncowa,View_ListaMediatorow.ident as ident, View_ListaMediatorow.adres2 as adres2, View_ListaMediatorow.zawieszony as zawieszony, View_ListaMediatorow.specjalizacjeWidok as specjalizacjeWidok FROM  View_ListaMediatorow LEFT OUTER JOIN tbl_specjalizacje_osob ON View_ListaMediatorow.ident = tbl_specjalizacje_osob.id_osoby where  View_ListaMediatorow.data_koncowa &gt;= getdate() order by nazwisko"></asp:SqlDataSource>
         ...
         <asp:Panel ID="archiwum" runat="server">
             ...
             <br />
             <asp:SqlDataSource ID="daneBieglychArchiwum" runat="server" ConnectionString="<%$ ConnectionStrings:wap %>" SelectCommand="SELECT DISTINCT View_ListaMediatorow.tytul as tytul, View_ListaMediatorow.imie as imie,  View_ListaMediatorow.uwagi as uwagi, View_ListaMediatorow.nazwisko as nazwisko, View_ListaMediatorow.adres as adres,View_ListaMediatorow.tel1 as telefon, View_ListaMediatorow.specjalizacja_opis as opis , View_ListaMediatorow.data_poczatkowa as data_poczatkowa, View_ListaMediatorow.data_koncowa as data_koncowa,View_ListaMediatorow.ident as ident, View_ListaMediatorow.adres2 as adres2, View_ListaMediatorow.zawieszony as zawieszony, View_ListaMediatorow.specjalizacjeWidok as specjalizacjeWidok FROM  View_ListaMediatorow LEFT OUTER JOIN tbl_specjalizacje_osob ON View_ListaMediatorow.ident = tbl_specjalizacje_osob.id_osoby where  View_ListaMediatorow.data_koncowa &lt; getdate() order by nazwisko"></asp:SqlDataSource>
         </asp:Panel>


        <dx:ASPxPopupControl ID="popup" ClientInstanceName="popup" runat="server" AllowDragging="True"
        PopupHorizontalAlign="OutsideRight" HeaderText="Dane biegłego" Theme="Aqua" MinHeight="300px" MinWidth="550px" CloseAction="CloseButton" OnUnload="popup_Unload" meta:resourcekey="popupResource1">
        <ContentCollection>
                                              ...
                                              <asp:Panel ID="Panel11" runat="server" Visible="False" Height="300px" Width="100%" HorizontalAlign="Center" meta:resourcekey="Panel11Resource1">
                                                  ...
                                                  <table style="width: 100%;">
                                                      <tr>
                                                          ...
                                                          <td align="center">
                                                                          <asp:LinkButton ID="LinkButton13" runat="server" CssClass="auto-style2" OnClick="usunSkarge" style="height: 12px" meta:resourcekey="LinkButton13Resource1">Usuń</asp:LinkButton>
