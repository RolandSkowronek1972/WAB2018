...
<dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="specjalizacjeOsob" Width="100%" KeyFieldName="id_" OnRowInserting="ASPxGridView1_RowInserting" EnableTheming="True" Theme="Moderno" OnRowUpdating="ASPxGridView1_RowUpdating" OnStartRowEditing="ASPxGridView1_StartRowEditing">
    ...
    <Columns>
        ...
        <dx:GridViewDataTextColumn FieldName="nazwa" VisibleIndex="2" Width="30%" Caption="Nazwa specjalizacji" ReadOnly="True">
            <EditItemTemplate>
           <dx:ASPxComboBox ID="ASPxComboBox1" runat="server" DataSourceID="SpecjalizacjeSQL" DropDownRows="10" SelectedIndex="0" Text='<%# Bind("nazwa") %>' Theme="Moderno" Value='<%# Bind("id_specjalizacji") %>' ValueField="id_" Width="100%" AutoPostBack="False" >
                    <Columns>
